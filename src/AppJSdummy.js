...
//  No use of this page until the new single page required without side-navbar 
...
export default function App() {
  ...
  const [Pathnamea, setPathnamea] = useState(pathname);
  ...
  return ( 
      ...
      pathname === '/homepage' ? ( direction === "rtl" ? (
